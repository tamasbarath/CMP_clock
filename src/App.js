...
class App extends Component {
  ...
  updateClocksOnUI = (days, hours, mins, secs) => {
    var initialOffset = 816.814089933346242;  // 2 * circle radius * pi = circumference /* 2x130 (r) x pi - . instead of , */
  ...
  clockInterval = (cmpTime, cmpText, dates) => {
    ...
    var interval = setInterval(function () {
      ...
      document.getElementById('nextCMPText').innerHTML = "Remaining time until " + cmpText;
     // document.getElementById('activecmp').innerHTML = cmpText + "is active";
      // time is up
        ...
        <Flex
          ...
          <div class="item html">
            ...
            <svg width="300" height="300" xmlns="http://www.w3.org/2000/svg">
              <g>
                <circle id="circle_d" class="circle_animation_d" r="130" cy="150" cx="150" stroke="#70ff57" />
              </g>
            </svg>
          </div>
          <div class="item html">
            ...
            <svg width="300" height="300" xmlns="http://www.w3.org/2000/svg">
              <g>ß
                <circle id="circle_h" class="circle_animation_h" r="130" cy="150" cx="150" stroke="#f7ff4b" />
              </g>
            </svg>
          </div>
          <div class="item html">
            ...
            <svg width="300" height="300" xmlns="http://www.w3.org/2000/svg">
              <g>
                <circle id="circle_m" class="circle_animation_m" r="130" cy="150" cx="150" stroke="#19b2ff" />
              </g>
            </svg>
          </div>
          <div class="item html">
            ...
            <svg width="300" height="300" xmlns="http://www.w3.org/2000/svg">
              <g>
                <circle id="circle_s" class="circle_animation_s" r="130" cy="150" cx="150" stroke="#fe8e00" />
              </g>
            </svg>
          </div>
        </Flex>
       {/*  <Flex justifyContent="left" >
          <div id="activecmp" className="activecmp nextCMPText" >APJ NEXT</div>
        </Flex> */}
      </div>
    );
  }
